    ...
    return (
        <footer className="bg-gray-900 text-white" id="contato">
            <div className="container mx-auto px-4 py-12">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 px-auto">
                    <div className="space-y-4">
                        <h3 className="text-xl font-bold">Courtly</h3>
                        <p className="text-gray-400">
                            A plataforma completa para gestão de quadras esportivas. Simplifique suas reservas e aumente seus
                            resultados.
                        </p>
                    ...
                    <div className="space-y-4">
                        ...
                        <ul className="space-y-2">
                            ...
                            <li>
                                <Link href="/vitrine" className="text-gray-400 hover:text-white transition-colors">
                                    Vitrine Demo
                                </Link>
                            </li>
                        </ul>
                    </div>
                    {
                        ...
                        //      <a href="mailto:contato@quadrasfacil.com" className="text-gray-400 hover:text-white transition-colors">
