                ...
                <div className="space-y-6">
                  <div className="text-center">
                    <p className="text-gray-600">
                      Sua reserva foi concluída com sucesso! Enviamos um código
                      de confirmação para o seu e-mail. Não esqueça de levá-lo
                      com você e apresenta-lo no local para validar sua reserva.
                    </p>
                  </div>
                  ...
                  <div className="space-y-3 text-sm">
                    ...
                    <ul className="space-y-2">
                      ...
                      <li className="flex items-start">
                        <CheckCircle className="h-4 w-4 text-green-600 mr-2 mt-0.5" />
                        <span>
                          Apresente o código de confirmação na recepção
                        </span>
                      </li>
                      ...
                      <li className="flex items-start">
                        <CheckCircle className="h-4 w-4 text-green-600 mr-2 mt-0.5" />
                        <span>
                          Caso queira cancelar sua reserva, clique no link do
                          email de confirmação de reserva enviado para você!
                        </span>
                      </li>
                    </ul>
                  </div>
