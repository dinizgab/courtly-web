  ...
  useEffect(() => {
    const fetchProfile = async () => {
      ...
      try {
        ...
        if (response.status === 200) {
          const { name, cnpj, phone, address, email, pix_key } =
            response.data as Company;
          const [street, numberAndNeighborhood] = address
            .split(",")
            .map((item) => item.trim());
          const [number, neighborhood] = numberAndNeighborhood
            .split("-")
            .map((item) => item.trim());
            ...
            <TabsContent value="informacoes">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Atualize as informações da sua empresa. Estas informações
                        ...
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem>
                              ...
                              <FormControl>
                                <div className="flex">
                                  <Input placeholder="Seu pix" {...field} />
                                </div>
                              </FormControl>
                              <FormMessage />
                            </FormItem>
