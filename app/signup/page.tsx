...
import { validateCNPJ, validatePIX } from "@/lib/validator";
...
const signupFormSchema = z
  .object({
    ...
    phone: z
      .string()
      .min(11, { message: "Telefone deve ter pelo menos 11 dígitos" }),
    companyName: z
      .string()
        ...
        <div className="max-w-md mx-auto">
          <Card>
            <CardHeader className="space-y-1">
              <CardTitle className="text-2xl font-bold text-center text-primary-heavy">
                Cadastro de Empresa
              </CardTitle>
